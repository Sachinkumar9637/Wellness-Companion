        ...
        <div class="col-md-3 p-3">
            ...
            while ($singleBooking = mysqli_fetch_array($bookings, MYSQLI_ASSOC)) {
                ...
                if ($currentDate < $bookingDate) {
                    ?>
                    <div
                        style="width:230px; background-color: #f5f5f5; padding: 10px; border-radius: 8px; margin-bottom: 15px; text-align: center;">
                        <p style="font-weight: bold; font-size: 1.35rem; color: #2d3a5c; margin: 0;">
                            📅 Booking Date: <?php echo date("l, F j, Y", strtotime($singleBooking["BookingDate"])); ?>
                        </p>
                        <p style="font-weight: bold; font-size: 1.35rem; color: #4a90e2; margin: 5px 0;">
                            ⏰ Booking Time: <?php echo date("g:i A", strtotime($singleBooking["BookingTime"])); ?>
                        </p>
                        <p style="color: #e94e77; font-size: 1.35rem; margin: 0;">
                            ⏳ Days remaining: <?php echo $daysRemaining; ?> Days and <?php echo $hoursRemaining; ?> Hours
                        </p>
                    </div>
                    <?php
                } else {
                    ?>
                    <div
                        style="width:230px; background-color: #ffe6e6; padding: 10px; border-radius: 8px; margin-bottom: 15px; text-align: center;">
                        <p style="font-weight: bold; font-size: 1.35 rem; color: #2d3a5c; margin: 0;">
                            📅 <?php echo date("l, F j, Y", strtotime($singleBooking["BookingDate"])); ?>
                        </p>
                        <p style="font-weight: bold; font-size: 1.35 rem; color: #e94e77; margin: 5px 0;">
                            ⏰ Booking Time: <?php echo date("g:i A", strtotime($singleBooking["BookingTime"])); ?>
                        </p>
                        <p style="color: #ff6347; font-size: 1.35 rem; margin: 0;">
